  ...
  <div class="pet_mian" >
    <div class="pet_head">
      <header data-am-widget="header"
        ...
        <div class="pet_news_list_tag_name">活动列表</div>
              ...
              <ul class="am-list">
                ...
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_hd_list">
                  <a href="###" class="pet_hd_block">
                    <div class="pet_hd_block_title">Less2.0 创业实战课程强势回归</div>
                    <div class="pet_hd_block_map"><i class="iconfont">&#xe632;</i>海淀区海淀大街27号亿景大厦3层西区</div>
                    <div class="pet_hd_block_tag"><span class="hd_tag_jh">筹备中</span> 10月20日 09:30 - 16:00 </div>
                  </a>
                </li>
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_hd_list">
                  <a href="###" class="pet_hd_block">
                    <div class="pet_hd_block_title">第二届网易未来科技峰会</div>
                    <div class="pet_hd_block_map"><i class="iconfont">&#xe632;</i>悠唐皇冠假日酒店</div>
                    <div class="pet_hd_block_tag"><span>报名中</span> 10月20日 09:30 - 16:00 </div>
                  </a>
                </li>
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_hd_list">
                  <a href="###" class="pet_hd_block">
                    <div class="pet_hd_block_title">2015京东移动技术峰会</div>
                    <div class="pet_hd_block_map"><i class="iconfont">&#xe632;</i>海淀区中关村创业大街昊海楼9楼</div>
                    <div class="pet_hd_block_tag"><span>报名中</span> 10月20日 09:30 - 16:00 </div>
                  </a>
                </li>
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_hd_list">
                  <a href="###" class="pet_hd_block">
                    <div class="pet_hd_block_title">京东技术开放日第十期：大数据驱动的智慧供应链</div>
                    <div class="pet_hd_block_map"><i class="iconfont">&#xe632;</i>国家会议中心2层/206会议室</div>
                    <div class="pet_hd_block_tag"><span>报名中</span> 10月20日 09:30 - 16:00 </div>
                  </a>
                </li>
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_hd_list">
                  <a href="###" class="pet_hd_block">
                    <div class="pet_hd_block_title">金融学院JWT外汇培训大型预览课邀请函</div>
                    <div class="pet_hd_block_map"><i class="iconfont">&#xe632;</i>福田区卓越世纪中心3号楼A座2206-07室</div>
                    <div class="pet_hd_block_tag"><span class="hd_tag_js">已截止</span> 10月20日 09:30 - 16:00 </div>
                  </a>
                </li>
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_hd_list">
                  <a href="###" class="pet_hd_block">
                    <div class="pet_hd_block_title">2015凤凰财经峰会：创变与繁荣</div>
                    <div class="pet_hd_block_map"><i class="iconfont">&#xe632;</i>东三环中路财富中心写字楼A座</div>
                    <div class="pet_hd_block_tag"><span class="hd_tag_js">已截止</span> 10月20日 09:30 - 16:00 </div>
                  </a>
                </li>
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_hd_list">
                  <a href="###" class="pet_hd_block">
                    <div class="pet_hd_block_title">Nature, Unnatural自然不自然装置艺术展</div>
                    <div class="pet_hd_block_map"><i class="iconfont">&#xe632;</i>南海大道1029号万融大厦B座4层</div>
                    <div class="pet_hd_block_tag"><span class="hd_tag_js">已截止</span> 10月20日 09:30 - 16:00 </div>
                  </a>
                </li>
                </ul>
