				  ...
				  <form method="post" class="am-form" data-am-validator="true" action="/register?from=user">
				      <div class="am-u-md-6">
				      	<div class="am-u-md-12 am-form-group">
				      		...
				      		<div class="am-u-md-9"><input type="email" class="" placeholder="邮箱地址" required="required" name="loginEmail" /></div>
				      	</div>
				      	<div class="am-u-md-12 am-form-group">
				      	...
				      	<div class="am-u-md-12 am-form-group">
				      		...
				      		<div class="am-u-md-9"><input type="password" id="doc-vld-pwd-1" class="" placeholder="密码" required="required" name="password" required="required" /></div>
				      	</div>
				      	<div class="am-u-md-12 am-form-group">
				      	...
				      	<div class="am-u-md-12 am-form-group">
				      		...
				      		<div class="am-u-md-9"><input type="text" class="" placeholder="输入手机号码" required="required" name="phoneNum" /></div>
				      	</div>
				      	<div class="am-u-md-12 am-form-group">
				      		<div class="am-u-md-3 lablel"><em>*</em>微信号码</div>
				      		
				      		<div class="am-u-md-9"><input type="text" class="" placeholder="输入微信号码" required="required" name="wechatCode" /></div>
				      	</div>
				      	
				      	<div class="am-u-md-12 am-form-group">
				      		<div class="am-u-md-3 lablel"><input type="hidden" id="userType" value="0" /></div>
				      		<div class="am-u-md-9">
				      		<button id="submit" class="am-btn am-btn-success">申请职位</button></div>
				      	</div>
				      </div>
			      </form>
				...
				<form method="post" class="am-form" data-am-validator="true" action="/register?from=company">
			     <div class="am-u-md-6 am-form">
					...
					<div class="am-u-md-12"><span class="title">账号信息</span></div>
			      	...
			      	<div class="am-u-md-12 am-form-group">
			      		<div class="am-u-md-3 lablel"><em>*</em>邮箱</div>
			      		<div class="am-u-md-9"><input type="email" class="" placeholder="邮箱地址" equired="required" name="loginEmail" /></div>
			      	</div>
			      	<div class="am-u-md-12 am-form-group">
			      		<div class="am-u-md-3 lablel"><em>*</em>密码</div>
			      		<div class="am-u-md-9"><input type="password" class="" placeholder="密码" required="required" /></div>
			      	</div>
			      	<div class="am-u-md-12 am-form-group">
			      		<div class="am-u-md-3 lablel"><em>*</em>确认密码</div>
					...
					<div class="am-u-md-12 am-form-group">
			      		...
			      		<div class="am-u-md-9"><input type="text" class="" placeholder="联系人名称" equired="required" name="userName" /></div>
			      	</div>
					<div class="am-u-md-12 am-form-group">
			      		<div class="am-u-md-3 lablel"><em>*</em>所在部门</div>
			      		<div class="am-u-md-9"><input type="text" class="" placeholder="部门名称" name="partment" /></div>
			      	</div>
			      	<div class="am-u-md-12 am-form-group">
			      		<div class="am-u-md-3 lablel"><em>*</em>手机号码</div>
			      		<div class="am-u-md-9"><input type="text" class="" placeholder="手机号码" equired="required" name="phoneNum" /></div>
			      	</div>
			      	<div class="am-u-md-12 am-form-group">
				      		<div class="am-u-md-3 lablel"><em>*</em>微信号码</div>
					...
					<div class="am-u-md-12 am-form-group">
			      		...
			      		<div class="am-u-md-9"><input type="text" class="" placeholder="公司名称" equired="required" name="companyName" /></div>
			      	</div>
					<div class="am-u-md-12 am-form-group">
			      		<div class="am-u-md-3 lablel"><em>*</em>所在地</div>
			      		<div class="am-u-md-9"><input type="text" class="" placeholder="请填写具体地址" equired="required" name="companyLoc" /></div>
			      	</div>
			      	<div class="am-u-md-12 am-form-group">
			      	...
			      	<div class="am-u-md-12 am-form-group">
			      		<div class="am-u-md-3 lablel"><input type="hidden" id="userType" value="0" /></div>
			      		<div class="am-u-md-9"><button id="submit" class="am-btn am-btn-success">申请入驻</button></div>
			      	</div>
			      </div>
			      </form>
			      <div class="am-u-md-6">请留下您的联系方式，我们会尽快与您沟通用人需求</div>
